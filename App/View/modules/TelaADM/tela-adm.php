...
<html lang="en">
  <head>
    ...
    <title>GL - Tela Funcionario</title>
...
<a href="logout"><button  type="submit" class="btn btn-success">Sair</button></a>
   ...
   <nav class="navbar navbar-light" style="background-color: #198754">
   <font face="Corbel Light" size="4.5" color="white"><center>ﾠﾠﾠBEM VINDO</center></a></font>
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0">Cadastro de Produtos</h6>
    <div class="d-flex text-muted pt-3">
      <svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#007bff"/><text x="50%" y="50%" fill="#007bff" dy=".3em">32x32</text></svg>

      <p class="pb-3 mb-0 small lh-sm border-bottom">
        <a href="produto/form">Cadastrar produtos</strong></a>
       </p>
    </div>
    <div class="d-flex text-muted pt-3">
      ...
      <p class="pb-3 mb-0 small lh-sm border-bottom">
      <a href="produto">Lista de Produtos</strong></a>
      </p>
    </div>
  </div>
    <div class="my-3 p-3 bg-body rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0">PAG SEGURO</h6>
    <div class="d-flex text-muted pt-3">
      <svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#007bff"/><text x="50%" y="50%" fill="#007bff" dy=".3em">32x32</text></svg>
  
        <div class="d-flex justify-content-between">
        
          <strong class="text-gray-dark"><a href="https://pagseguro.uol.com.br/#rmcl">Gerenciar Conta</strong></a>
        </div>
    </div>
</div>
   <br>
