			...
			<h2>Cadastro</h2>
                <div class="form-row">
                    <div class="form-row">
                        ...
                        <input name="nome"  placeholder="Nome" class="form-control" value="<?= isset($dados_usuario) ? $dados_usuario->nome : "" ?>" type="text" required />
                    </div>
                    <div class="form-row">
					...
					<input type="password"  class="form-control" name="password" id="password" class="input-text" placeholder="Senha" required value="<?= isset($dados_usuario) ? $dados_usuario->senha : "" ?>">
				</div>
