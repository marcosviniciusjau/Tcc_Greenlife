...
<body class="form-v6">
	<div class="page-content">
		<div class="form-v6-content">
            ...
            <?php if (isset($_GET['duplicate_email_adm']) || isset($validations['duplicate_email_adm']))  : ?>
            ...
            <?php endif ?>
            <form method="post" action="/adm/salvar" class="form-detail" enctype="multipart/form-data">
			<h2>Cadastro</h2>
                <div class="form-row">
                
                    <div class="form-row">
					<input type="email"  class="form-control" name="email_adm" id="email_adm" class="input-text" value="<?= $model->email_adm ?>" placeholder="Email" required >
                    </div>

					<div class="form-row">
					<input type="password"  class="form-control" name="senha_adm" id="senha_adm" class="input-text" value="<?= $model->senha_adm ?>" placeholder="Senha" required >
						</div>
