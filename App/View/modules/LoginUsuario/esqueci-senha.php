...
<head>
	<meta charset="utf-8">
	<title>GL - Redefinir Senha</title>
...
<body class="form-v6">
	<div class="page-content">
		<div class="form-v6-content">
			...
			<form class="form-detail" action="/enviar-nova-senha" method="post">
            <?php if(isset($retorno)): ?>
				...
				<div class="form-row-last">
					<input type="submit" name="register" class="register" value="Enviar Senha">
				</div>
                
				<div class="cadastro">
					<center><p><font color="Black"> Não possui uma conta?</p></font></center>
					<center><p><a href="/usuario/cadastrar"><font color="#0b320b">Voltar</a></p></font></center>
			</div>
