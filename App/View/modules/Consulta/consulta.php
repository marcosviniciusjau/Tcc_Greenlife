...
<div id="email"><a href="https://mail.google.com/mail/"><img src="View/Imagens/Header/email.png" width="40" height="40"></a></div>
   ...
   <body>
    ...
    <?php foreach($model->rows as $item): ?>
      ...
      <center><img src="/View/Uploads/<?= $item->imagem ?>"  alt="..."></center>
      <center><img src="/View/Uploads/<?= $item->imagem ?>"  width="113" height="111"></center>
      <center><img src="/View/Uploads/<?= $item->imagem ?>"  width="113" height="111"></center>
      <center><img src="/View/Uploads/<?= $item->imagem ?>"  width="113" height="111"></center>
    </hr>
    <div class="col-4">
      <b><font size="5"><?= $item->nome ?></b></font>
      <br>
<b><font size="5"><?= $item->valor ?></b></font>
    <h5 class="card-title"><center><?= $item->descricao ?></center></h5>
    ...
    <a class=" w-50 btn btn-primary" href="https://pagseguro.uol.com.br/#rmcl" style="background-color: #077B3B ; color:#FFFFFF">COMPRAR</a>
    <a class=" w-50 btn btn-primary" href="carrinho_cliente" style="background-color: #077B3B ; color:#FFFFFF">COMPRAR</a>
